const ModalCancel = ({ onClose, onConfirm }) => {
  return (
    <div
    ...
    >
      ...
      >
        <div className=" bg-fixed z-50 flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md bg-slate-800 text-white">
          <h3 className="flex items-center gap-2 text-xl font-semibold leadi tracki text-red-600">
            <svg
            ...
            saving the data? Your chapter data will be lost if you
            cancel
          </h3>
